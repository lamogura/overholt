...
@secured_route(bp, '/<store_id>')
def show(store_id):
    """Returns a store instance."""
    return _stores.get_or_404(store_id)


@secured_route(bp, '/<store_id>', methods=['PUT'])
def update(store_id):
...
@secured_route(bp, '/<store_id>', methods=['DELETE'])
def delete(store_id):
...
@secured_route(bp, '/<store_id>/products/<product_id>', methods=['DELETE'])
...
@secured_route(bp, '/<store_id>/managers')
